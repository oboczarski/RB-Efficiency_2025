...
function buildDerivedPlayers() {
  return PLAYERS.map((player) => {
    ...
    return { ...player, top3, top5, rushingComposite, receivingComposite, bestMetric }
  })
}
...
function runDataChecks(players) {
  return [
    ...
    { label: "Top five list contains five rows", pass: players.length >= 5 },
    {
                ...
                <div className="overflow-x-auto xl:overflow-visible">
                  <div className="w-fit min-w-0">
                    <div className="grid w-fit grid-cols-[158px_repeat(8,70px)_92px] gap-2 pb-2 text-white/48">
                      <div className="flex items-center px-3 text-[12px] font-semibold uppercase text-white/48">Player</div>
                      {METRICS.map((metric) => (
                      ...
                      <div className="flex items-center justify-center px-3 text-center text-[12px] font-semibold uppercase text-white/48">AVG</div>
                    </div>
